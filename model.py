...
def apply_update(params, grads, learning_rate):
    ...
    nw= params['w']- learning_rate*grads['dw']
    nb= params['b']- learning_rate*grads['db']
    return {
        'w': nw,
        'b': nb
    }
...
def train_svm(x, y, learning_rate, reg_lambda, n_epochs):
    ...
    _, n_f= x.shape
    params= initialize_parameters(n_f)
